...
describe("medirProporcionalidade", () => {
  ...
  it("negócio no ritmo não trava nada", () => {
    ...
    const r = medirProporcionalidade(d, ["31/12/2025", "31/05/2026"], ["31/05/2026"])!;
  ...
  it("série que já chegou em dezembro não é janela parcial", () => {
    ...
    expect(medirProporcionalidade(d, ["31/12/2025", "31/12/2026"], ["31/12/2026"])).toBeNull();
  });
  ...
  it("linha com base perto de zero no fechamento é ignorada (não vira razão absurda)", () => {
    ...
    const r = medirProporcionalidade(d, PER, YTD)!;
...
describe("medirProporcionalidade · bordas que a revisão encontrou", () => {
  ...
  it("balancete de DEZEMBRO encerrado (janela de 1 mês) não serve de exercício fechado", () => {
    ...
    const bals = [{ periodo: "31/12/2025", periodoInicio: "01/12/2025", provas: { exercicioEncerrado: true } }];
    // dava ritmo 11,61x contra um denominador que é um mês
    expect(medirProporcionalidade(d, ["31/12/2025", "31/05/2026"], ["31/05/2026"], bals)).toBeNull();
  });
  ...
  it("com o documento ANUAL e o balancete de dezembro juntos, o ano vence", () => {
    ...
    const bals = [{ periodo: "31/12/2025", periodoInicio: "01/12/2025", provas: { exercicioEncerrado: true } }];
    const r = medirProporcionalidade(d, ["2025", "31/12/2025", "31/05/2026"], ["31/05/2026"], bals)!;
  ...
  it("balancete de encerramento que cobre o exercício (01/01) É aceito", () => {
    ...
    const bals = [{ periodo: "31/12/2025", periodoInicio: "01/01/2025", provas: { exercicioEncerrado: true } }];
    expect(medirProporcionalidade(d, ["31/12/2025", "31/05/2026"], ["31/05/2026"], bals)!.periodoFechado).toBe("31/12/2025");
  });
  ...
  it("fechamento velho demais não é referência do mesmo negócio", () => {
    ...
    expect(medirProporcionalidade(d, ["2019", "31/05/2026"], ["31/05/2026"])).toBeNull();
  });
