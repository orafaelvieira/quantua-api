...
export const DRE_TEMPLATE: Array<{ conta: string; subtotal: boolean }> = [
  ...
  { conta: "Custos com Pessoas (MOD)", subtotal: false },
  { conta: "Lucro Bruto", subtotal: true },
  // Abertura v7 (15/07/2026, definida pelo usuário): despesas operacionais por
  // natureza — o dicionário classifica direto nelas; todas pesam no EBITDA.
  { conta: "Despesas com Pessoas", subtotal: false },
  { conta: "Despesas Gerais e Administrativas", subtotal: false },
  { conta: "Despesas com Aluguel, Condomínio e IPTU", subtotal: false },
  { conta: "Despesas com Energia, Água, Telefone e Internet", subtotal: false },
  { conta: "Despesas com Sistemas e Softwares", subtotal: false },
  { conta: "Despesas com Limpeza, Manutenção e Reparos", subtotal: false },
  { conta: "Despesas com Viagens e Estadias", subtotal: false },
  { conta: "Despesas com Veículos", subtotal: false },
  { conta: "Despesas com Seguros", subtotal: false },
  { conta: "Despesas com Fretes", subtotal: false },
  { conta: "Despesas Taxas, Tributos e Contribuições", subtotal: false },
  { conta: "Despesas com Terceiros", subtotal: false },
